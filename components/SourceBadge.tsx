...
export function SourceBadge({ source, credibility, compact = false }: SourceBadgeProps) {
  ...
  return (
    <span className="source-badge inline-flex min-w-0 max-w-full items-center gap-2 rounded-lg border border-white/15 bg-slate-950/45 px-2.5 py-1.5 text-xs font-bold text-slate-100 shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_10px_28px_rgba(0,0,0,0.24)] backdrop-blur-xl">
