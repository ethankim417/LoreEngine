...
const currentArticleTranslations: Record<string, ArticleTranslation> = {
  "le-001": { sourceSlug: "gamescom-turns-scale-into-industry-infrastructure", title: "Gamescom이 기록적 규모를 산업 인프라로 바꿨다", tldr: "Gamescom에 관람객 36만 8천 명, 업계 관계자 3만 6천 명, 전시사 1,743곳이 모였고 디지털 조회수는 6억 2,400만 회를 기록했다.", fullTldr: "국제 참가, 업계 방문, 전시사, 디지털 도달 범위가 모두 늘며 발견, 개발, 정책, 투자가 한 행사에 모였다.", whyItMatters: "출시와 제휴, 채용, 크리에이터 유통, 정책, 자본을 잇는 공동 인프라가 되고 있다.", possibleImpact: "퍼블리셔와 스튜디오는 연간 계획과 마케팅을 Gamescom 주간에 더 집중할 수 있다.", trendAnalysis: "분산된 게임 업계의 관심이 소비자와 기업을 함께 겨냥한 글로벌 대형 행사로 재집중된다." },
  "le-002": { sourceSlug: "dlss-45-makes-ai-rendering-a-platform-default", title: "DLSS 4.5가 AI 렌더링을 플랫폼 기본값으로 만든다", tldr: "NVIDIA가 DLSS 4.5 Ray Reconstruction을 출시하고 Gamescom 출품작 전반으로 RTX 지원을 넓혔다.", fullTldr: "향상된 재구성 기술을 RTX Spark, 신규 게임 통합, RTX Remix 업데이트와 묶었다.", whyItMatters: "렌더링 차별화가 개발사가 통합하고 이용자가 기대하는 공급업체 소프트웨어 계층에 더 의존한다.", possibleImpact: "스튜디오는 재구성 지원을 더 일찍 예산에 반영하고 GPU 경쟁은 생태계 채택으로 이동할 수 있다.", trendAnalysis: "AI 보조 렌더링이 선택 기능에서 반복적으로 쓰이는 플랫폼 역량으로 바뀐다." },
  "le-003": { sourceSlug: "unreal-city-sample-operationalizes-agentic-worldbuilding", title: "Unreal City Sample이 에이전트형 월드 제작을 실전화한다", tldr: "Epic이 Unreal Engine 5.8 City Sample에 PCG와 Unreal MCP 워크플로를 추가했다.", fullTldr: "대규모 참조 프로젝트에서 절차적 도시 제작과 편집기 연결형 에이전트를 보여준다.", whyItMatters: "팀이 실제 제작 규모의 콘텐츠와 반복 가능한 엔진 작업으로 에이전트 개발을 평가할 수 있다.", possibleImpact: "스튜디오는 제한된 편집기 작업에 MCP를 도입하며 권한, 검토, 출처, 되돌리기 규칙을 세울 수 있다.", trendAnalysis: "코딩 에이전트가 게임 엔진 내부의 구조화된 제작 흐름으로 들어간다." },
  "le-004": { sourceSlug: "xbox-reopens-the-exclusivity-question", title: "Xbox가 독점작 전략을 다시 검토한다", tldr: "하드웨어 압박 속에서 Xbox 경영진이 The Elder Scrolls VI 독점 가능성을 열어뒀다.", fullTldr: "멀티플랫폼 확대 이후 Xbox가 핵심 퍼스트파티 콘텐츠를 자사 하드웨어와 스토어 강화에 쓸지 다시 저울질한다.", whyItMatters: "Microsoft는 소프트웨어 도달 범위와 Xbox 생태계에 들어올 이유를 함께 지켜야 한다.", possibleImpact: "Bethesda 대작의 출시 플랫폼이 작품별 전략 수단이 될 수 있다.", trendAnalysis: "콘솔 전략이 일괄 정책에서 프랜차이즈별 선택으로 이동한다." },
  "le-005": { sourceSlug: "rovio-closure-tests-segas-mobile-synergy", title: "Rovio 스튜디오 폐쇄가 Sega의 모바일 시너지를 시험한다", tldr: "Sega가 소프트 출시한 Sonic Blitz를 취소하고 Rovio 코펜하겐 스튜디오를 닫는다.", fullTldr: "2023년 인수 뒤 Angry Birds와 Sonic의 검증된 자산에 다시 집중하는 흐름이다.", whyItMatters: "모바일 전문성 인수만으로 흥행 위험과 라이브 서비스 운영 압박이 사라지지 않는다.", possibleImpact: "Sega는 검증된 IP 중심으로 모바일 제작을 통합하고 소프트 출시 기준을 높일 수 있다.", trendAnalysis: "퍼블리셔는 인수한 모바일 포트폴리오를 유명 브랜드와 빠른 유지율 증거 중심으로 좁힌다." },
  "le-006": { sourceSlug: "steam-depot-leak-expands-platform-liability", title: "Steam 저장소 유출이 플랫폼 책임 범위를 넓혔다", tldr: "12TB 규모의 과거 Steam 저장소에서 수백 개 게임의 미출시 빌드와 자산이 노출됐다.", fullTldr: "2003~2013년 Valve와 서드파티 프로젝트 자료가 포함됐다.", whyItMatters: "스토어의 보관 책임은 현재 이용자 계정을 넘어 장기간의 보안·IP 노출을 만든다.", possibleImpact: "플랫폼과 스튜디오는 과거 저장소, 보존 정책, 접근 제어, 사전 출시 콘텐츠를 재점검할 수 있다.", trendAnalysis: "플랫폼 위험이 상거래와 신원뿐 아니라 잠든 개발 데이터까지 포함한다." },
  "le-007": { sourceSlug: "creator-backlash-removes-ai-from-1666-amsterdam", title: "이용자 반발로 1666: Amsterdam이 AI를 걷어냈다", tldr: "Panache는 사전 제작 단계의 생성형 AI 사용 논란 뒤 이를 프로젝트에서 완전히 제거했다고 밝혔다.", fullTldr: "생성 자산이 공개 콘텐츠에 섞인 뒤 앞으로 해당 기술을 쓰지 않겠다고 했다.", whyItMatters: "AI 정책이 내부 생산성뿐 아니라 제품 포지셔닝과 신뢰의 문제가 됐다.", possibleImpact: "수작업 창작성을 내세우는 스튜디오는 자산 단위 공개와 검토를 강화할 수 있다.", trendAnalysis: "엔진 내 에이전트 도구는 늘지만 이용자 반응은 생성형 AI의 실질적 경계를 만든다." },
  "le-008": { sourceSlug: "gamescom-congress-broadens-games-policy-role", title: "Gamescom Congress가 게임의 정책 역할을 넓힌다", tldr: "산업계, 정부, 학계, 시민사회가 모인 Gamescom Congress가 역대 최다 참가를 기록했다.", fullTldr: "교육, 보건, 민주주의, 접근성, AI, 업계 진입을 게임과 연결했다.", whyItMatters: "업계의 정당성과 정책 영향력이 엔터테인먼트 매출 밖의 활용에 더 의존한다.", possibleImpact: "기업은 공공 협력을 늘리는 동시에 AI와 노동 정책의 직접적 검증을 받을 수 있다.", trendAnalysis: "게임 행사가 상업 쇼케이스를 넘어 정책 포럼이 된다." },
  "le-009": { sourceSlug: "playstation-extends-console-brand-to-the-desktop", title: "PlayStation이 콘솔 브랜드를 데스크톱으로 넓힌다", tldr: "Sony가 DualSense 충전 걸이를 갖춘 PS5·PC용 27인치 게이밍 모니터를 출시했다.", fullTldr: "349.99달러 QHD 디스플레이는 HDR, VRR, PS5 120Hz, 호환 PC 240Hz를 지원한다.", whyItMatters: "PlayStation이 데스크톱을 PC 브랜드에 맡기지 않고 교차 기기 이용 공간으로 본다.", possibleImpact: "Sony는 콘솔과 PC를 잇는 주변기기로 생태계 결속을 강화할 수 있다.", trendAnalysis: "콘솔 플랫폼이 플레이 공간을 둘러싼 라이프스타일 하드웨어로 확장한다." },
  "le-010": { sourceSlug: "sega-rebuilds-around-recognizable-franchises", title: "Sega가 친숙한 프랜차이즈 중심으로 라인업을 재편한다", tldr: "Sega가 Persona, Crazy Taxi, Total War, Alien, Sonic을 아우르는 6개 프로젝트를 Gamescom에 선보였다.", fullTldr: "유명 IP를 중심으로 리메이크, 후속작, 장르 전환, 네트워크 테스트를 섞었다.", whyItMatters: "친숙한 브랜드는 발견 위험을 낮추면서 통제된 제품 실험을 가능하게 한다.", possibleImpact: "Sega는 약한 모바일 실험을 줄이고 IP 확장에 자본을 더 배분할 수 있다.", trendAnalysis: "대형 퍼블리셔가 익숙한 브랜드를 제품 실험의 그릇으로 쓴다." },
  "le-011": { sourceSlug: "sports-broadcasts-test-game-native-viewing", title: "스포츠 중계가 게임형 시청 방식을 시험한다", tldr: "EA Sports, Sky, Bundesliga가 실시간 스포츠의 애니메이션·비디오게임형 중계를 시험했다.", fullTldr: "스포츠 권리, 게임 엔진, 대안 중계, 젊은 스트리밍 시청자를 연결한다.", whyItMatters: "게임 기술은 주 중계를 대체하지 않고도 새 권리 상품과 스폰서 지면을 만든다.", possibleImpact: "리그와 퍼블리셔가 게임형 동시 중계와 크리에이터 해설을 늘릴 수 있다.", trendAnalysis: "e스포츠 제작 방식이 전통 스포츠 유통으로 번진다." },
  "le-012": { sourceSlug: "epic-packages-58-skills-as-continuous-learning", title: "Epic이 UE 5.8 역량을 상시 학습 체계로 묶는다", tldr: "Epic의 8월 학습 자료가 네트워크 물리, 동적 오디오, 최적화, 애니메이션, MCP를 다룬다.", fullTldr: "Unreal Engine 5.8 기능을 여러 산업의 무료 실무형 교육과 연결했다.", whyItMatters: "엔진 채택은 복잡한 출시 기능을 실제 제작 습관으로 바꾸는 속도에 달렸다.", possibleImpact: "스튜디오는 공급업체 교육에 더 의존하고 전문가는 고급 통합으로 이동할 수 있다.", trendAnalysis: "학습 콘텐츠가 게임 엔진 경쟁력의 일부가 된다." },
  "le-013": { sourceSlug: "quantum-tools-enter-commercial-game-production", title: "양자 도구가 상업 게임 제작에 들어왔다", tldr: "C.L.A.Y.가 IBM 양자 시뮬레이터로 지도, 캐릭터, 그래픽을 생성했다.", fullTldr: "Gamescom 시연은 양자 보조 생성을 연구가 아닌 상업 제작 실험으로 제시했다.", whyItMatters: "절차적 시스템이 특이한 출력을 흡수할 수 있어 게임은 새 컴퓨팅 모델의 초기 시험장이 된다.", possibleImpact: "단기 채택은 제한적이지만 공급업체가 실험적 생성·최적화 서비스를 더할 수 있다.", trendAnalysis: "성숙한 시장이 생기기 전에 스튜디오가 기존 GPU 밖의 계산 방식을 시험한다." },
  "le-014": { sourceSlug: "gamescom-theft-exposes-demo-build-risk", title: "Gamescom 도난이 데모 빌드 위험을 드러냈다", tldr: "여러 전시사의 미완성 빌드와 회사 데이터가 든 노트북과 휴대용 기기가 도난당했다.", fullTldr: "잠긴 보관함에서도 장비가 사라져 소스, 자격 증명, 개인정보 노출 가능성이 생겼다.", whyItMatters: "소규모 전시사는 민감한 작업물을 붐비는 행사장에 직접 들고 간다.", possibleImpact: "암호화 기기, 일회성 계정, 추적, 사고 대응 계획이 늘 수 있다.", trendAnalysis: "대형 오프라인 행사가 원격 쇼케이스에 없던 운영 보안 위험을 되살린다." },
  "le-015": { sourceSlug: "playstation-packages-gamescom-discovery-at-scale", title: "PlayStation이 Gamescom의 발견성을 자사 채널로 묶는다", tldr: "Sony가 Gamescom의 서드파티 타이틀 20개를 하나의 PlayStation 편집 채널에 모았다.", fullTldr: "기존 프랜차이즈와 신규 작품을 함께 소개하며 행사 관심을 자사 생태계로 돌렸다.", whyItMatters: "발표가 넘칠수록 원시 정보보다 플랫폼이 통제하는 큐레이션의 가치가 커진다.", possibleImpact: "퍼블리셔는 스토어 증폭을 노리고 발표를 설계하며 플랫폼의 지속 노출 영향력은 커질 수 있다.", trendAnalysis: "행사 발견성이 기업 소유 미디어와 스토어를 통해 필터링된다." }
};
