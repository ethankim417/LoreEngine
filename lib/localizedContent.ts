...
const previousWeekArticleTranslations: Record<string, ArticleTranslation> = {
...
void previousWeekArticleTranslations;

const currentArticleTranslations: Record<string, ArticleTranslation> = {
  "le-001": { sourceSlug: "us-gpu-prices-jump-as-memory-pressure-spreads", title: "GPU 가격 충격이 미국 소매시장까지 번졌다", tldr: "미국 RTX 50 시리즈의 중간 판매가가 최대 39% 오르며 아시아에서 시작된 가격 상승이 주요 시장으로 확산했다.", fullTldr: "Tom's Hardware가 Newegg의 8월 판매가를 추적한 결과 RTX 5070은 36%, RTX 5060은 27% 상승했다.", whyItMatters: "PC 업그레이드 예산과 개발사가 겨냥할 수 있는 하드웨어 기반을 직접 흔드는 글로벌 가격 사이클이다.", possibleImpact: "이용자는 구형 카드를 더 오래 쓰고 개발사는 확장형 옵션과 낮은 메모리 사양을 더 중시할 수 있다.", trendAnalysis: "AI 인프라 수요와 메모리 제약이 게임용 GPU의 가격 부담을 세계적인 플랫폼 문제로 만들고 있다." },
  "le-002": { sourceSlug: "ea-private-ownership-turns-to-cost-discipline", title: "EA의 비상장 전환이 비용 규율을 앞세운다", tldr: "550억 달러 규모의 비상장 전환이 끝난 뒤 EA가 연간 7억 달러 비용 절감을 추진한다는 보도가 나왔다.", fullTldr: "큰 부채와 효율화 목표가 결합되며 포트폴리오, 인력, 투자 우선순위가 즉시 검증대에 올랐다.", whyItMatters: "게임 업계에서 가장 폭넓은 카탈로그 중 하나가 사모 자본의 수익 기준 아래 놓였다.", possibleImpact: "검증된 프랜차이즈 집중, 기능 통합, 실험적 프로젝트의 높은 수익 기준이 예상된다.", trendAnalysis: "대형 게임 인수는 거래 완료 직후 운영 구조 압축으로 빠르게 이어지고 있다." },
  "le-003": { sourceSlug: "take-two-sees-streaming-as-hardware-pressure-valve", title: "Take-Two가 스트리밍을 하드웨어 부담의 출구로 본다", tldr: "Take-Two CEO는 콘솔과 PC 가격이 오르는 가운데 3년 안에 게임 스트리밍이 상업적으로 중요해질 것으로 전망했다.", fullTldr: "Strauss Zelnick은 비싸진 로컬 하드웨어와 유통 전략을 직접 연결했다.", whyItMatters: "기기 가격이 접근성의 병목이 되면 클라우드 게임의 전략적 가치가 커진다.", possibleImpact: "퍼블리셔는 클라우드 권리, 지연시간 설계, 구독 구성, 스트리밍 제휴를 재검토할 수 있다.", trendAnalysis: "하드웨어 인플레이션이 기기 중심 접근에서 서비스 중심 접근으로의 이동을 재촉한다." },
  "le-004": { sourceSlug: "japan-mobile-game-bankruptcies-hit-record-pace", title: "일본 모바일 게임사 파산이 사상 최고 속도로 늘었다", tldr: "2026년 1~7월 일본 스마트폰 게임 사업자 10곳이 파산해 이미 2025년 전체를 크게 웃돌았다.", fullTldr: "帝国データバンク는 서비스 종료, 운영비 상승, 치열한 경쟁으로 연간 역대 최고치를 경신할 가능성이 크다고 분석했다.", whyItMatters: "모바일 시장 집중이 소규모 사업자의 생존 문제로 수치화됐다.", possibleImpact: "퍼블리셔는 회수 기간을 줄이고 기술 재사용과 글로벌 확장성이 큰 타이틀을 선호할 수 있다.", trendAnalysis: "성숙한 모바일 시장은 자본력과 유입 채널, 대규모 콘텐츠 파이프라인을 가진 사업자에게 유리하다." },
  "le-005": { sourceSlug: "gamescom-developers-rank-ai-as-biggest-change", title: "Gamescom 개발자들이 AI를 가장 큰 변화로 꼽았다", tldr: "Gamescom 연사 설문에서 AI가 게임 개발을 바꿀 가장 큰 요인으로 나타났다.", fullTldr: "개발자들은 AI가 제작을 바꿀 것에는 대체로 동의했지만 이익과 위험이 어디에 나타날지는 엇갈렸다.", whyItMatters: "AI 도입은 특정 도구 실험을 넘어 전 직군의 운영 모델 문제가 되고 있다.", possibleImpact: "스튜디오는 사용 정책, 교육, 출처 관리, 업무별 성과 측정을 공식화할 수 있다.", trendAnalysis: "논점은 AI 사용 여부에서 AI를 어떻게 통제하고 측정할지로 이동한다." },
  "le-006": { sourceSlug: "fortnite-lowers-friction-for-paid-creators", title: "Fortnite가 수익형 크리에이터의 진입 장벽을 낮췄다", tldr: "Epic이 Fortnite 개발자 프로그램 가입 절차를 간소화해 더 많은 제작자가 출시와 수익 배분에 참여할 수 있게 했다.", fullTldr: "8월 업데이트는 실험에서 상업 참여까지의 경로를 단축한다.", whyItMatters: "낮은 진입 장벽은 콘텐츠 공급을 늘리고 크리에이터 확보를 플랫폼 성장 수단으로 만든다.", possibleImpact: "신규 섬과 제작자는 늘지만 발견성, 품질 관리, 수익 집중 문제가 커질 수 있다.", trendAnalysis: "UGC 플랫폼은 플레이어가 경제활동을 하는 제작자가 되는 속도로 경쟁한다." },
  "le-007": { sourceSlug: "creator-platforms-balance-stars-and-newcomers", title: "크리에이터 플랫폼이 신인 육성 비용을 수치화한다", tldr: "새 연구가 스타의 즉시 매출과 신인 크리에이터의 장기 성장 사이에서 트래픽을 배분하는 방법을 제시했다.", fullTldr: "추천이 현재 수익과 미래 공급을 함께 결정하는 플랫폼을 위한 동적 배분 모델이다.", whyItMatters: "게임 제작 플랫폼도 효율적인 추천이 기존 강자를 고착시키고 차세대 히트를 약화하는 딜레마를 겪는다.", possibleImpact: "UGC 사업자는 신규 제작자 노출을 보장하고 더 긴 수익 기간으로 추천을 평가할 수 있다.", trendAnalysis: "추천은 단순 정렬이 아니라 크리에이터 생태계의 자본 배분이 되고 있다." },
  "le-008": { sourceSlug: "gpu-deals-disappear-into-a-higher-price-baseline", title: "GPU 할인은 사라지고 가격 기준선은 높아졌다", tldr: "가격 추적 결과 고급 GPU는 출시가를 크게 웃돌고 현행 제품군의 의미 있는 할인도 드물다.", fullTldr: "NVIDIA, AMD, Intel 판매가를 함께 비교해 개별 제품이 아닌 시장 전반의 압박을 보여준다.", whyItMatters: "권장가가 아닌 실제 판매가가 이용자와 개발사가 감당할 수 있는 하드웨어를 결정한다.", possibleImpact: "교체 주기가 길어지고 개발사의 구형 사양 지원 압박이 커질 수 있다.", trendAnalysis: "일시적 부품 급등이 더 높은 게임 컴퓨팅 가격 하한으로 굳어지고 있다." },
  "le-009": { sourceSlug: "high-memory-geforce-cards-take-the-largest-hit", title: "고용량 GeForce 카드가 가장 큰 가격 충격을 받았다", tldr: "메모리 비용이 소매가에 반영되면서 8GB를 넘는 NVIDIA 카드의 부담이 특히 커졌다.", fullTldr: "AI 시대의 메모리 수요와 게임 하드웨어 가격이 직접 연결되고 있다.", whyItMatters: "최신 게임에는 VRAM이 더 중요해지지만 이용자가 그 용량을 사는 비용도 커진다.", possibleImpact: "메모리 요구량이 큰 게임에 대한 반발과 프리미엄 기능의 등급화가 강화될 수 있다.", trendAnalysis: "산업이 원하는 성능 기준은 오르지만 감당 가능한 하드웨어 기준은 반대로 움직인다." },
  "le-010": { sourceSlug: "amd-price-rise-erodes-the-value-alternative", title: "AMD 가격 인상이 가성비 대안을 약화한다", tldr: "AMD가 8월 Radeon 보드와 메모리 키트 가격을 최소 10% 올렸다는 보도가 나왔다.", fullTldr: "AMD와 NVIDIA가 모두 높아진 메모리 비용을 파트너에 전가하며 PC 조립의 가격 피난처가 줄었다.", whyItMatters: "두 주요 업체가 같은 공급 제약을 받으면 경쟁만으로 소비자를 보호하기 어렵다.", possibleImpact: "Intel에 기회가 생길 수 있지만 공급과 소프트웨어 성숙도가 수요 흡수를 제한할 수 있다.", trendAnalysis: "부품 인플레이션이 특정 고급 브랜드가 아닌 시장 전체 문제로 바뀐다." },
  "le-011": { sourceSlug: "ewc-packages-esports-as-a-season", title: "Esports World Cup이 경쟁을 하나의 시즌으로 묶는다", tldr: "EWC 마지막 주가 클럽 순위, 다수 종목, 크리에이터, 티켓, 페스티벌 프로그램을 결합한다.", fullTldr: "24개 e스포츠의 25개 이벤트가 8월 23일까지 이어지며 경기 밖의 클럽 정체성, 크리에이터 유통, 관광까지 상품화한다.", whyItMatters: "개별 대회로 만들기 어려운 반복 시청과 스폰서 상품을 여러 종목에 걸쳐 구축한다.", possibleImpact: "퍼블리셔와 팀은 종목 간 클럽 프로그램과 공동 중계, 시즌 서사를 더 중시할 수 있다.", trendAnalysis: "e스포츠가 흩어진 게임 커뮤니티를 대형 시즌으로 묶고 있다." },
  "le-012": { sourceSlug: "august-esports-calendar-concentrates-global-attention", title: "8월 e스포츠 일정에 세계의 관심이 집중된다", tldr: "EWC 폐막 종목, The International, 주요 지역 리그가 8월 한 기간에 겹친다.", fullTldr: "최상위 대회들이 시청자, 스폰서, 공동 중계자, 제작 역량을 동시에 놓고 경쟁한다.", whyItMatters: "일정 밀도는 전체 시청층을 키울지 같은 관심을 나눌지 시험한다.", possibleImpact: "주최사는 크리에이터 유통과 일정 조율, 차별화된 형식에 더 투자할 수 있다.", trendAnalysis: "e스포츠의 행사 규모가 관심 분산 문제를 푸는 속도보다 빠르게 커진다." },
  "le-013": { sourceSlug: "g5-results-test-mobile-portfolio-resilience", title: "G5 실적이 모바일 포트폴리오의 회복력을 시험한다", tldr: "G5의 상반기 실적은 어려운 이용자 확보 시장에서 자체 모바일 타이틀이 얼마나 버틸지 보여준다.", fullTldr: "8월 12일 실적 발표는 소규모 스튜디오와 글로벌 플랫폼 사이에 있는 중견 퍼블리셔의 직접 지표다.", whyItMatters: "중견사의 실적은 대형 IP와 광고 생태계 밖에서도 모바일 경제성이 유지되는지 보여준다.", possibleImpact: "동종사는 출시 수를 줄이고 자체 IP 비중과 보수적 마케팅을 강화할 수 있다.", trendAnalysis: "모바일 전략은 대규모 포트폴리오와 규율 있는 틈새 사업자로 양극화한다." },
  "le-014": { sourceSlug: "ea-take-private-closes-at-55-billion", title: "EA의 550억 달러 비상장 전환이 완료됐다", tldr: "사우디 PIF가 이끄는 투자자 그룹이 EA 인수를 마치며 회사가 비상장사로 전환됐다.", fullTldr: "대형 퍼블리셔와 카탈로그의 지배권이 큰 부채를 포함한 컨소시엄 구조로 넘어갔다.", whyItMatters: "스포츠, 슈팅, 시뮬레이션, RPG를 아우르는 프랜차이즈의 지배구조가 바뀐다.", possibleImpact: "자본 배분, 출시 주기, 인력, 실험적 투자 모두 새 수익 기준의 영향을 받을 수 있다.", trendAnalysis: "국부펀드와 사모 자본이 전례 없는 규모로 핵심 게임 카탈로그를 직접 지배한다." },
  "le-015": { sourceSlug: "physical-media-debate-moves-to-storefront-economics", title: "실물 미디어 논쟁이 스토어 경제성으로 이동한다", tldr: "전 Square Enix 재무 임원은 디지털 전용 PlayStation이 Steam처럼 가격 경쟁을 강화할 수 있다고 주장했다.", fullTldr: "디스크 논쟁을 제조비뿐 아니라 스토어 경쟁, 수수료, 할인, 소비자 협상력의 문제로 다시 본다.", whyItMatters: "실물 유통 제거는 비용을 줄이지만 가격 결정력을 플랫폼 스토어에 집중시킨다.", possibleImpact: "Sony는 디스크가 줄어들수록 더 강한 할인과 이동성, 소유권 보호를 입증해야 할 수 있다.", trendAnalysis: "플랫폼 전략의 중심이 하드웨어 형식에서 디지털 접근과 가격 경쟁의 통치 방식으로 이동한다." }
};
