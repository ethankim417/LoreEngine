...
export const translations = {
  en: {
    ...
    bookmarksSynced: "Bookmarks saved in cloud",
    cloudPending: "Saving bookmarks to cloud",
    localBookmarkMode: "Bookmarks saved on this device",
    cloudSyncNote: "Bookmark storage status",
  ...
  ko: {
    ...
    bookmarksSynced: "북마크가 클라우드에 저장됨",
    cloudPending: "북마크를 클라우드에 저장 중",
    localBookmarkMode: "북마크가 이 기기에 저장됨",
    cloudSyncNote: "북마크 저장 상태",
