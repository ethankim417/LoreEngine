...
- Add authenticated admin review for generated briefs.
- Add category-specific dashboards for AI, platforms, engines, studios, and market signals.
- Add week-over-week comparisons and trend history.
- Add user-saved views and watchlists.
