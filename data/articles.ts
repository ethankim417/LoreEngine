...
export const briefSnapshotDate = "2026-07-07";
...
export const articles: Article[] = [
  ...
  {
    id: "le-002",
    slug: "xbox-profit-pressure-becomes-industry-warning-signal",
    title: "Xbox profit pressure becomes industry warning signal",
    source: "Business Insider",
    sourceCredibility: "Trade press",
    category: "Business",
    tldr: "Xbox's restructuring is being framed as a symptom of wider problems in console economics, subscription growth, and AAA cost control.",
    fullTldr: "Business Insider connected the Xbox cuts to weak console momentum, Game Pass expectations, rising hardware costs, and a player base concentrating around a small number of evergreen games. The signal is broader than Microsoft: scale alone is not fixing the industry's margin problem.",
    whyItMatters: "If one of the industry's largest balance sheets is reducing exposure to internally funded development, mid-sized studios and service bets face a colder funding environment.",
    possibleImpact: "Expect publishers to favor proven IP, shared technology, lower-risk co-development, and releases that can travel across PlayStation, Nintendo, PC, and cloud storefronts.",
    trendAnalysis: "The trend is operating leverage over empire building: gaming companies are being rewarded less for owning more studios and more for proving each studio can compound returns.",
    impactScore: 92,
    trendScore: 46,
    confidence: 82,
    ...
    publishedAt: "2026-07-07",
    sourceUrl: "https://www.businessinsider.com/microsoft-xbox-layoffs-business-reset-gaming-industry-challenges-2026-7",
    visual: { image: "/images/intelligence/business-market.webp", alt: "Dark gaming market intelligence terminal with holographic charts" }
  },
  {
    id: "le-003",
  ...
  {
    id: "le-006",
    slug: "nvidia-roadmap-noise-shows-how-ai-compute-now-moves-gaming-stocks",
    title: "NVIDIA roadmap noise shows how AI compute now moves gaming stocks",
    source: "Investor's Business Daily",
    sourceCredibility: "Market analysis",
    category: "Hardware",
    tldr: "NVIDIA pushed back on reports of AI architecture delays, and investors treated the roadmap dispute as material.",
    fullTldr: "Investor's Business Daily reported that NVIDIA dismissed claims of a major delay to its future AI computing architecture, while analysts framed the report as market noise. Even though the coverage centers on data-center AI, it matters to games because NVIDIA's valuation, PC GPU supply, DLSS roadmap, and local AI tooling all sit on the same investor narrative.",
    whyItMatters: "Gaming hardware companies are increasingly priced around AI execution. That changes how investors interpret product delays, memory demand, and consumer GPU availability.",
    possibleImpact: "Expect gaming GPU messaging to lean harder into AI acceleration, creator workflows, and on-device inference rather than pure raster performance.",
    trendAnalysis: "The trend is AI-led hardware valuation: gaming GPUs are now judged through a data-center roadmap lens first and a consumer upgrade-cycle lens second.",
    impactScore: 82,
    trendScore: 40,
    confidence: 78,
    ...
    publishedAt: "2026-07-07",
    sourceUrl: "https://www.investors.com/news/technology/nvidia-stock-rumored-ai-computer-delay-called-noise/",
    visual: { image: "/images/intelligence/hardware-ai.webp", alt: "Close-up of a futuristic GPU board with glowing compute traces" }
  },
  {
    id: "le-007",
  ...
  {
    id: "le-008",
    slug: "amd-radeon-memory-risk-keeps-pc-gaming-prices-unstable",
    title: "AMD Radeon memory risk keeps PC gaming prices unstable",
    source: "TechRadar",
    sourceCredibility: "Trade press",
    category: "Hardware",
    tldr: "Reports of Radeon graphics-memory cost increases add another pressure point for consumer GPU pricing.",
    fullTldr: "TechRadar reported that AMD's Radeon ecosystem could face graphics-memory price increases in July, citing VideoCardz coverage of board-channel chatter. The signal is not the exact percentage; it is that PC gaming component prices remain vulnerable to memory supply pressure even as consumers resist higher hardware costs.",
    whyItMatters: "GPU affordability affects Steam hardware adoption, PC upgrade timing, creator workstations, and how much budget players have left for software.",
    possibleImpact: "Expect more attention on bundled PCs, used GPUs, older-generation cards, cloud gaming trials, and performance-scaling features like upscaling.",
    trendAnalysis: "The trend is hardware value hunting: gamers and creators are comparing total system cost more aggressively as memory price volatility spreads across the stack.",
    impactScore: 78,
    trendScore: 37,
    confidence: 72,
    ...
    publishedAt: "2026-07-02",
    sourceUrl: "https://www.techradar.com/computing/gpu/amds-radeon-gpus-may-be-the-next-victim-of-the-ram-crisis-and-it-makes-this-gaming-pc-deal-look-even-more-of-a-bargain",
    visual: { image: "/images/intelligence/hardware-ai.webp", alt: "Close-up of a futuristic GPU board with glowing compute traces" }
  },
  {
    id: "le-009",
