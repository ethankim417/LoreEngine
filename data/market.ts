...
export const marketSnapshotDate = "2026-09-01";
...
export const staticMarketSnapshot: MarketSnapshot = {
  ...
  groups: marketGroups,
  dataSourceLabel: "Yahoo public close-price fallback through 2026-09-01 where available; not real-time data or financial advice",
  mode: "cached-fallback",
  refreshedAt: `${marketSnapshotDate}T00:00:00.000Z`,
  updatedTickers: ["NVDA", "AMD", "INTC", "MSFT", "SONY", "NTDOY", "U", "TCEHY", "NTES", "EA", "TTWO", "RBLX", "CCOEY", "KONMY", "NCBDY", "SQNXF"],
  failedTickers: [
    "EPIC"
  ],
  failedTickerReasons: {
