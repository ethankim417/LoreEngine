...
export const marketPlayers: MarketPlayer[] = [
  ...
  },
  {
    ...
    sentiment: "Bullish",
    summary:
      "Unity is strategically important to mobile and indie developers, but the latest free close-price check was unavailable during this fallback refresh.",
  ...
  },
  {
    ...
    sentiment: "Watch",
    summary:
      "Roblox remains one of the clearest public UGC indicators, but the latest free close-price check was unavailable during this fallback refresh.",
...
export const staticMarketSnapshot: MarketSnapshot = {
  ...
  groups: marketGroups,
  dataSourceLabel: "Cached fallback snapshot from public close-price checks; not financial advice",
  ...
  failedTickers: ["U", "TCEHY", "RBLX", "CCOEY", "KONMY", "NCBDY", "SQNXF"],
  failedTickerReasons: {
